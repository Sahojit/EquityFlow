...
@patch("agents.web_researcher.create_span")
...
def test_web_researcher_fallback_without_tavily_key(
    mock_create_span: MagicMock,
) -> None:
    """web_researcher_node returns empty list and does not crash when TAVILY_API_KEY is absent."""
    import os
...
def test_web_researcher_skips_failed_questions(
    ...
    """web_researcher_node skips questions where Tavily throws, returns partial results."""
    mock_tavily = MagicMock()
